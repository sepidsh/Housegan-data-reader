...
Input Data
------
![alt text](https://github.com/sepidshs/images/0.png "Sample")
...
The data file (e.g., /data/floorplan_0.json), which could be generated by *predict.lua* (\*_popup.txt), has the following format:
